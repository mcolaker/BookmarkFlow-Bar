...
<p align="center">
  ...
  <img alt="Source version 0.1.39" src="https://img.shields.io/badge/source-0.1.39-F2C94C">
...
<p align="center">
  ...
  <a href="https://github.com/mcolaker/BookmarkFlow-Bar/releases/download/v0.1.39/bookmarkflow-bar-0.1.39.zip">Download verified v0.1.39</a> ·
  <a href="https://github.com/mcolaker/BookmarkFlow-Bar/releases/download/v0.1.39/bookmarkflow-bar-0.1.39.zip.sha256">Verify SHA-256</a> ·
...
<p align="center">
  <sub><strong>Project status:</strong> Chrome Web Store listing live · verified v0.1.39 GitHub Release published · <a href="CHANGELOG.md">Changelog</a></sub>
</p>
...
1. Download the verified [`bookmarkflow-bar-0.1.39.zip`](https://github.com/mcolaker/BookmarkFlow-Bar/releases/download/v0.1.39/bookmarkflow-bar-0.1.39.zip) package and extract it. Its published [SHA-256 checksum](https://github.com/mcolaker/BookmarkFlow-Bar/releases/download/v0.1.39/bookmarkflow-bar-0.1.39.zip.sha256) is available for integrity verification. Contributors can clone the repository instead:
...
Maintainers can create a versioned extension ZIP and SHA-256 checksum from a release tag with `node scripts/package-release.mjs v0.1.39`.
...
- **Download the [verified v0.1.39 source release](https://github.com/mcolaker/BookmarkFlow-Bar/releases/tag/v0.1.39)** for audit or development use and follow the [source installation guide](#install-from-source).
