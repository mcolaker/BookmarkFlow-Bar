...
- Sonraki adım: Chrome Web Store Dashboard ve yayıncı e-postasını izle; durum `Approved` veya `Published` olduğunda herkese açık mağaza URL'sini, sürümü ve tarihi kaydet, mağazadan temiz kurulumla çubuk/yeni sekme/varsayılan arama akışını doğrula ve görevi `DONE` yap.
- Son güncelleme: 2026-08-02.
